...
and print_out_type_1 ppf =
  function
    Otyp_arrow (lab, ty1, ty2) ->
      ...
      pp_close_box ppf ()
  | Otyp_implicit_arrow (lab, Otyp_module pkg, ty2) ->
      pp_open_box ppf 0;
      print_package ~implicit_:lab ppf pkg;
      pp_print_string ppf " ->";
      pp_print_space ppf ();
      print_out_type_1 ppf ty2;
      pp_close_box ppf ()
...
and print_simple_out_type ppf =
  ...
  | Otyp_variant (non_gen, row_fields, closed, tags) ->
      ...
      fprintf ppf "%s@[<hov>[%s@[<hv>@[<hv>%a@]%a@]@ ]@]"
        ...
        print_present tags
  | Otyp_alias _ | Otyp_poly _ | Otyp_arrow _ | Otyp_implicit_arrow _
  | Otyp_tuple _ as ty ->
      pp_open_box ppf 1;
      pp_print_char ppf '(';
  ...
  | Otyp_module pkg -> print_package ppf pkg
