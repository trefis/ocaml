...
5 |       let x = T
6 |     end
Error: The type t/147 introduced by this open appears in the signature
       Line 7, characters 8-9:
         The value y has no valid type if t/147 is hidden
|}];;
...
Error: The type t/152 introduced by this open appears in the signature
       Line 6, characters 8-9:
         The value y has no valid type if t/152 is hidden
|}]
